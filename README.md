...
Este projeto marca o meu primeiro desafio de código na jornada de Engenharia de Software. O objetivo foi criar uma lógica que classifica um herói com base na sua experiência (XP).
...
* Sintaxe: Como lidar com concatenação de strings e operadores lógicos.
...
2. Clone este repositório: `git clone https://github.com/MAbaptistaContab/desafio-do-felipao`
3. Abra o arquivo index.js no seu editor.
